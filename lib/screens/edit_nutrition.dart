...
class EditNutritionScreen extends StatefulWidget {
  ...
  @override
  _EditNutritionScreenState createState() => _EditNutritionScreenState();
}
...
class _EditNutritionScreenState extends State<EditNutritionScreen> {
  ...
  void didChangeDependencies() {
    if (_isInit) {
      ...
      if (productId != null) {
        _editedProduct =
            Provider.of<FoodCombo>(context, listen: false).findById(productId);
        _initValues = {
  ...
  Future<void> _saveForm() async {
    ...
    if (_editedProduct.id != null) {
      await Provider.of<FoodCombo>(context, listen: false)
