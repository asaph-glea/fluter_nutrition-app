          ...
          Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  Color.fromRGBO(105, 105, 105, 1).withOpacity(0.5),
...
class _AuthCardState extends State<AuthCard> {
  ...
  Future<void> _submit() async {
    ...
    try {} on HttpException catch (error) {
      ...
      if (error.toString().contains('EMAIL_EXISITS')) {
        ...
        errorMessage = 'Email user does not exisit';
      ...
      const errorMessage =
          'Authorization was Unsuccesful. Please try again Later';
      _showErrorDialog(errorMessage);
    }
    setState(() {
      _isLoading = false;
